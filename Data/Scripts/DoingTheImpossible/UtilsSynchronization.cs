...
namespace SpaceEquipmentLtd.Utils
{
  ...
  public class SyncEntityId
  {
    ...
    public static SyncEntityId GetSyncId(object item)
    {
      ...
      IMySlimBlock slimBlock = item as IMySlimBlock;
      if (slimBlock != null)
      {
      ...
      IMyVoxelBase voxelBase = item as IMyVoxelBase;
      if (voxelBase != null)
      {
        return new SyncEntityId() { Box = voxelBase.WorldAABB };
      }

      IMyEntity entity = item as IMyEntity;
      if (entity != null)
      {
        return new SyncEntityId() { EntityId = entity.EntityId };
      }

      Vector3D? position = item as Vector3D?;
      if (position != null)
      {
    ...
    public static IMySlimBlock GetItemAsSlimBlock(SyncEntityId id)
    {
      ...
      IMyCubeBlock block = item as IMyCubeBlock;
      if (block != null)
      {
    ...
    {
      SyncEntityId syncObj = obj as SyncEntityId;
